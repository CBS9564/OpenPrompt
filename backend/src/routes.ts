...
export const setupRoutes = (db: Database) => {
  ...
  router.post('/prompts', async (req, res) => {
    try {
      const { id, title, description, tags, text, category, author, isRecommended, createdAt, isPublic, supportedInputs } = req.body;
      await db.run(
  ...
  router.post('/agents', async (req, res) => {
    try {
      const { id, title, description, tags, systemInstruction, author, isRecommended, createdAt, isPublic } = req.body;
      await db.run(
  ...
  router.post('/contexts', async (req, res) => {
    try {
      const { id, title, description, content, author, tags, isPublic } = req.body;
      await db.run(
